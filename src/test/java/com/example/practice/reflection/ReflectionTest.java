...
public class ReflectionTest {
    ...
    @Test
    @DisplayName("People Class의 정보를 가져온다.")
    ...
    @Test
    @DisplayName("Heap 영역에 로드돼 있는 People Class의 정보를 가져온다.")
    void getUserClassInfoOnHeapTest() throws Exception{
        // 1
        Class<People> userClazz = People.class;

        // 2
        People user = new People("id", "name");
        Class<? extends People> userClazz2 = user.getClass();

        // 3
        Class<?> userClazz3 = Class.forName("com.example.practice.reflection.model.People");
